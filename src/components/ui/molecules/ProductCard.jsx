...
export default function ProductCard({ tourId, imgSrc, title, desc, price, className ,key }) {
  const route = useRouter();
  return (
    <figure key={key} className={`bg-white shadow-cus-1 rounded-[10px] overflow-hidden ${className}`}>
