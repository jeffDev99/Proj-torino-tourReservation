...
export default function MainMenu({ className,menu, setMenu }) {
  return (
    <div
    ...
    >
      <ul className={`flex lg:items-center gap-7 flex-col lg:flex-row fixed right-0 top-0 bottom-0 rounded-e-xl w-[209px] lg:w-full  lg:static bg-white pt-8 lg:pt-0 ps-3 flex-1  transition-all ${menu ? "right-0" : "right-[-209px]"}`}>
        <li>
